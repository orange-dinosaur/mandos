...
/// Test that the delete_account grpc method works
/// Steps:
...
/// 5. Call the delete_account grpc method
/// 6. Check that the user has been deleted
/// 7. Check that the session has been deleted
